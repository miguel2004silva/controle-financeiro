...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-dvh w-full bg-zinc-50/50 text-foreground overflow-x-hidden font-sora select-none">
      ...
      {/* ---------------------------------------------------- */}
      {/* RIGHT SIDE: CENTRED PREMIUM FORM (MATCHING KOMADI DIMENSIONS) */}
      {/* ---------------------------------------------------- */}
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12 z-20">
        ...
        <div className="w-full max-w-[450px] bg-white border border-zinc-200/50 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-zinc-200/30 flex flex-col space-y-6">
          ...
          {/* Error Banner */}
          {error && (
            <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200/70 text-rose-600 text-xs font-bold flex items-start gap-2.5 animate-in fade-in duration-200">
